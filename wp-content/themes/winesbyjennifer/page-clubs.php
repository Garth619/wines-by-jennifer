...
<div class="inner_banner">
	<div class="banner_overlay">
		...
		<h1><img class="ribbon ribbon_left" src="<?php bloginfo('template_directory');?>/images/ribbon.png"/>Clubs<img class="ribbon ribbon_right" src="<?php bloginfo('template_directory');?>/images/ribbon-right.png"/></h1>
...
<div class="clubs club_one">
	...
	<div class="club_right club_right_content wow fadeIn" data-wow-delay="0.75s">
		<div id="content">
			<h1>Wine Club</h1>
	...
	<div class="club_left club_left_image wow fadeIn" data-wow-delay="0.75s">
...
<div class="clubs club_two">
	...
	<div class="club_left club_left_content wow fadeIn" data-wow-delay="0.75s">
		<div id="content">
			<h1>Cellar Club</h1>
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla</p>
			<a href="" class="button">Learn More <div class="arrow-right-white"></div></a>
	...
	<div class="club_right club_right_image wow fadeIn" data-wow-delay="0.75s">
