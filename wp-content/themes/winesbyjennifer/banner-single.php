...
<div class="inner_banner" style="background: rgba(0, 0, 0, 0) url(<?php the_field('inner_banner', 91);?>) no-repeat scroll center top / cover ;">
	...
	<div class="banner_overlay">
		...
		<a style="padding-bottom:80px;" href="<?php bloginfo('url');?>/about-us/wines-by-jennifer-blog" class="back_to_blog">Return To In The News Feed</a>
...
<?php endif;?>	
	...
	<div class="banner_overlay">
		...
		<h1><img class="ribbon ribbon_left" src="<?php bloginfo('template_directory');?>/images/ribbon.png"/><?php the_field('front_title');?><img class="ribbon ribbon_right" src="<?php bloginfo('template_directory');?>/images/ribbon-right.png"/></h1>
