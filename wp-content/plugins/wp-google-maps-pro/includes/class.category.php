...
add_action('wpgmza_marker_saved', 		array('WPGMZA\\Category', 'rebuildTableFromLegacyField'));	// Only for specified marker
add_action('wpgmza_marker_deleted', 	array('WPGMZA\\Category', 'rebuildTableFromLegacyField'));	// Only for specified marker
