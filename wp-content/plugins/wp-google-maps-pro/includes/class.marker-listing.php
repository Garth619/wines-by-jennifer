...
//		}
		...
		if (isset($wpgmza_settings['wpgmza_settings_markerlist_link'])) { $hide_link_column = $wpgmza_settings['wpgmza_settings_markerlist_link']; } else { $hide_link_column = false; } 
			...
			if ($display > 0 && $c_display > 0) {
				...
				if ($admin) {
					...
					if ($type == 1)
					{
						...
						if (!(isset($hide_link_column) && $hide_link_column == "yes"))
							$wpgmza_tmp_body .= "<div class='wpgmza-link'>
													<a target='_blank' href='".$result->link."'>".$wpgmza_settings['wpgmza_settings_infowindow_link_text']."</a>
												</div>";
					...
					else if ($type == 2)
					{
						...
						if (!(isset($hide_link_column) && $hide_link_column == "yes")) 				
							$wpgmza_tmp_body .= "<td class='wpgmza_table_link'><a target='_blank' href='".$result->link."'>".$wpgmza_settings['wpgmza_settings_infowindow_link_text']."</a></td>";
					...
					else if ($type == 3)
					{
						...
						if ($carousel_show_link && !empty($result->link))
							$wpgmza_tmp_body .= "<p class='wpgmza_marker_link'>
													<a href='".stripslashes($result->link)."' target='_BLANK'>"
														. (!empty($wpgmza_settings['wpgmza_settings_infowindow_link_text']) ? $wpgmza_settings['wpgmza_settings_infowindow_link_text'] : __( "Link", "wp-google-maps" )) .
													"</a>
												</p>";
						...
						if (!(isset($hide_link_column) && $hide_link_column == "yes"))
							$wpgmza_tmp_body .= "<td class='wpgmza_table_link'>
													<a target='_blank' href='".$result->link."'>".$wpgmza_settings['wpgmza_settings_infowindow_link_text']."</a>
												</td>";
		...
		if ($admin) {
			...
			if ($type == 1) {
				...
				if (!(isset($hide_link_column) && $hide_link_column == "yes"))
					$wpgmza_tmp_head .= "<th class='wpgmza_table_link'>
											<strong>"
												.apply_filters("wpgmza_filter_link_name",__("Link","wp-google-maps")).
											"</strong>
										</th>";
